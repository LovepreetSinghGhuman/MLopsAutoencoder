document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderResult(result) {
    // Check if both TransactionID and IsFraud exist and are arrays
    if (result.TransactionID && result.IsFraud && Array.isArray(result.TransactionID) && Array.isArray(result.IsFraud)) {
